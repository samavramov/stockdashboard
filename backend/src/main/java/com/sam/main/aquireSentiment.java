...
public class aquireSentiment {
   ...
   /**
    * Fetch sentiment for a given article URL using Ollama's sentiment analysis model.
    * @param url
    * @param company
    * @return A double representing the sentiment score:
    *         -1.0 to 0.0 for negative sentiment,
    *         0.0 for neutral sentiment,
    *         0.0 to +1.0 for positive sentiment.
    *         Returns 0.0 if the sentiment cannot be determined.
    * @throws Exception
    */
